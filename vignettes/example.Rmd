...
data(ensg_hgnc)
zero_proportion_plot(toydata, switch_to_hgnc = TRUE, ref = ref)
hippo_feature_heatmap(toydata, k = 2, 
                      switch_to_hgnc = TRUE, 
                      ref = ensg_hgnc, 
                      top.n = 20)
...
```{r}
toydata = diffexp(toydata, top.n = 5, switch_to_hgnc = TRUE, 
                  ref = ensg_hgnc)
```
...
head(hippo_object$diffexp$result_table[[1]])
head(hippo_object$diffexp$result_table[[2]])
```
