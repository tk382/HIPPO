---
title: "Example1: Start from SingleCellExperiment"
output:
...
hippo_feature_heatmap(sce, switch_to_hgnc = TRUE, ref = ref, top.n = 5, kk=4)
```
...
```{r}
sce = hippo_diffexp(sce, top.n = 5, switch_to_hgnc = TRUE, ref = ref)
```
