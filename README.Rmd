...
```{r diagnostic, warning = FALSE, fig.height = 3, fig.width = 3}
...
```{r umap, warning = FALSE, fig.width = 6, fig.height = 2}
...
```{r featureselection, fig.height = 3, fig.width = 6}
data(ensg_hgnc)
...
```{r diffexp, fig.width = 6, fig.height = 2}
sce = diffexp(sce, 
                  top.n = 5, 
                  switch_to_hgnc = TRUE, 
                  ref = ensg_hgnc)
